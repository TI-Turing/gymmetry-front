  ...
  const loadUserProfile = useCallback(async () => {
    try {
      ...
      const mockProfile: UserProfile = {
        ...
        bio: 'Apasionado por el fitness y la vida saludable.',
      ...
      const mockPosts: UserPost[] = [
        {
          ...
          content: 'Completé una sesión intensa de piernas.',
        ...
        },
        {
          ...
          content: 'Esta semana logré aumentar el peso en press de banca.',
        ...
        },
        {
          ...
          content:
            'Descubrí que agregar más proteína en el desayuno me da más energía.',
