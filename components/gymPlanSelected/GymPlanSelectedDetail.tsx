...
export function GymPlanSelectedDetail() {
  ...
  const fetchOne = async () => {
    ...
    try {
      const res =
        await gymPlanSelectedFunctionsService.getGymPlanSelectedById(id);
      setItem(res.Data);
    } catch (_e) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>GymPlanSelected - Detalle</Text>
