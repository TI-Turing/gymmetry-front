...
import { dailyExerciseHistoryService } from '@/services';

export function DailyExerciseHistoryForm() {
  ...
  const onAdd = async () => {
    ...
    try {
      ...
      const res =
        await dailyExerciseHistoryService.addDailyExerciseHistory(body);
  ...
  const onUpdate = async () => {
    ...
    try {
      const body = JSON.parse(payload);
      const res =
        await dailyExerciseHistoryService.updateDailyExerciseHistory(body);
  ...
  const onDelete = async () => {
    ...
    try {
      const res =
        await dailyExerciseHistoryService.deleteDailyExerciseHistory(id);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>DailyExerciseHistory - Formulario</Text>
