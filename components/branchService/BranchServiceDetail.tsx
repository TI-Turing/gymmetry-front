...
export function BranchServiceDetail() {
  ...
  const fetchOne = async () => {
    ...
    setError(null);
    try {
      const res = await branchServiceFunctionsService.getBranchServiceById(id);
      setItem(res.Data);
    } catch (_e) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>BranchService - Detalle</Text>
