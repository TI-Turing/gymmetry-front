...
import { branchServiceFunctionsService } from '@/services/functions';

export function BranchServiceForm() {
  ...
  const onAdd = async () => {
    ...
    try {
      ...
      const res = await branchServiceFunctionsService.addBranchService(body);
  ...
  const onUpdate = async () => {
    ...
    try {
      const body = JSON.parse(payload);
      const res = await branchServiceFunctionsService.updateBranchService(body);
  ...
  const onDelete = async () => {
    ...
    setMsg(null);
    try {
      const res = await branchServiceFunctionsService.deleteBranchService(id);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>BranchService - Formulario</Text>
