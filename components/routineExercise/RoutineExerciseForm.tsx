...
export function RoutineExerciseForm() {
  ...
  const onAdd = async () => {
    ...
    try {
      ...
      const res = await routineexerciseService.addRoutineExercise(body);
  ...
  const onUpdate = async () => {
    ...
    try {
      const body = JSON.parse(payload);
      const res = await routineexerciseService.updateRoutineExercise(body);
  ...
  const onDelete = async () => {
    ...
    setMsg(null);
    try {
      const res = await routineexerciseService.deleteRoutineExercise(id);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>RoutineExercise - Formulario</Text>
