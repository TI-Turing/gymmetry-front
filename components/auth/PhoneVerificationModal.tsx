        ...
        >
          ...
          {verificationStep === 'checking' && (
            <View style={{ alignItems: 'center', justifyContent: 'center', minHeight: 120 }}>
              <FontAwesome name="spinner" size={40} color={Colors[colorScheme ?? 'light'].tint} style={{ marginBottom: 16 }} />
              <Text style={{ color: Colors[colorScheme ?? 'light'].text, fontSize: 16, textAlign: 'center' }}>
                Verificando número...
              </Text>
            </View>
          )}
          ...
          {verificationStep === 'error' && (
            <View style={{ alignItems: 'center', justifyContent: 'center', minHeight: 120 }}>
              <FontAwesome name="exclamation-triangle" size={40} color={Colors[colorScheme ?? 'light'].tint} style={{ marginBottom: 16 }} />
              <Text style={{ color: Colors[colorScheme ?? 'light'].text, fontSize: 16, textAlign: 'center', marginBottom: 12 }}>
